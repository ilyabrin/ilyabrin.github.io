...
- [Официальная документация PostgreSQL по VACUUM](https://www.postgresql.org/docs/current/sql-vacuum.html)
- [Статья о работе autovacuum в PostgreSQL](https://www.cybertec-postgresql.com/en/autovacuum-in-postgresql/)
- [Использование pg_repack для реорганизации таблиц](https://reorg.github.io/pg_repack/)
