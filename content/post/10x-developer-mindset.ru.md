---
title: "Как перестать волноваться о своём коде и стать x10 разработчиком"
...
Код должен читаться как книга. Комментарий, объясняющий *что* делает код - признак плохих имён. Комментарий, объясняющий *почему* - иногда необходим.
